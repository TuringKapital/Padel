...
async def set_date_and_wait(page, date_str):
    ...
    # Verify the date on screen matches what we set
    actual_date = await page.evaluate(JS_GET_CURRENT_DATE)
    log.info("Date on page: %s (expected %s)", actual_date, date_str)
